...
function createHeaderRow(category) {
  ...
  // headerCell.innerHTML = '<table width="100%" class="headertable"><tr><td style="text-align:right; width:50%">'+category.name+'&nbsp;</td><td style="text-align:left; width: 50%;">&nbsp;' + "<input class='inh' type='number' value="+parseFloat(category.weight)*100+'>%</td></tr></table>';
...
function createRow(assignment, isMock) {
  ...
  // scoreCell.addEventListener("change", function(){
  //   updateRow(assignment.id);
  // })
